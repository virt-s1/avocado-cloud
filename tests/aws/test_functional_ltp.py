...
class LTPRun(Test):
    ...
    def test_ltp_hugemmap(self):
        ...
        key_steps:
            ...
            2. Download and install ltp tool from https://github.com/linux-test-project/ltp 
               or download the built rpm package from below url:
               x86_64: https://github.com/liangxiao1/rpmbuild_specs/releases/download/ltp-master-20200514/ltp-master-20200514.x86_64.rpm
               aarch64: https://github.com/liangxiao1/rpmbuild_specs/releases/download/ltp-master-20200514/ltp-master-20200514.aarch64.rpm
